...
class GeneratorsManager:
    ...
    def execute_generator(self, generator: PDDLGenerator) -> bool:
        ...
        try:
            # Track existing files to isolate the new ones generated by the subprocess
            ...
            if is_stdout_mode:
                ...
                # Identify newly created problem and plan files
            ...
            # Callback to handle file renaming and saving via utilities
